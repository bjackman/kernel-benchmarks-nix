# Copied from nixpkgs, modified to point at a different src.
# Should be able to just do this with a nixpkgs overlay like this:
#
# firecracker = prev.firecracker.overrideAttrs (old: {
#   src = prev.fetchFromGitHub {
#     owner = "firecracker-microvm";
#     repo = "firecracker";
#     rev = "feature/secret-hiding";
#     hash = "sha256-8tpeAmcCIoOSxbjHshtmtutnLiiGgL9gEMtEf8Bjgnc=";
#   };
#   cargoHash = "sha256-AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=";
# });
#
# But I get cargo hash errors I don't understand.
...
rustPlatform.buildRustPackage rec {
  ...
  cargoHash = "sha256-BvYVYi7Op8ZE0KWFGdt27mo1YzQH9tSd6pMz1KFcaQ4=";
